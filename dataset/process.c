    ...
    for (i = 3; i <= NUM_USERS; i++)
    {
        ...
        if(fp != NULL)
        {
            ...
            while(fgets(line, sizeof line, fp) != NULL ) 
            {
                    ...
                    switch(index)
                    {
                        case 0:
                            ...
                            if(strcmp(prevDate, "") == 0)
                            {
                                ...
                                char filename[50] = "trace";
                                strcat(filename, file_write);
                ...
                int numCols = (minLong - maxLong - 0.01)*25;
                int x = (int)((newPoint->latNum - minLat)*25);
                int y = (int)((newPoint->lotNum - maxLong)*25);
